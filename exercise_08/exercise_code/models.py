...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=32):
        super().__init__()
...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=32, output_size=28 * 28):
        super().__init__()
...
class Autoencoder(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        #optim=torch.optim.Adam(self.decoder.parameters(), lr=self.hparams["lr"])
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        self.model = nn.Sequential(
            ...
            nn.ReLU(),
            #nn.BatchNorm1d(self.hparams["n_hidden1"]),
            #nn.Linear(self.hparams["n_hidden1"], self.hparams["n_hidden1"]),
            #nn.LeakyReLU(),
            nn.Linear(self.hparams["n_hidden1"], self.hparams["n_hidden1"]),
            nn.ReLU(),
            #nn.Linear(self.hparams["n_hidden1"], self.hparams["n_hidden1"]),
            #nn.ReLU(),
            #nn.BatchNorm1d(self.hparams["n_hidden1"]),
            nn.Linear(self.hparams["n_hidden1"], 10)
        )
    ...
    def configure_optimizers(self):
        ...
        #optim=torch.optim.RMSprop(self.model.parameters(), lr=0.01)
